...
import slimeknights.tconstruct.mantle.client.model.BakedCompositeModel;
import slimeknights.tconstruct.mantle.client.model.TRSRBakedModel;
...
public class BakedTableModel extends BakedModelWrapper<IBakedModel> {
  ...
  private static class TableItemCombinationCacheKey {
    ...
    public boolean equals(Object o) {
      ...
      if(!Objects.equals(tableItems, that.tableItems)) {
        return false;
      }
      if(!Objects.equals(bakedBaseModel, that.bakedBaseModel)) {
        return false;
      }
