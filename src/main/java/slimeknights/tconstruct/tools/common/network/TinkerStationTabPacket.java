...
import slimeknights.tconstruct.mantle.network.AbstractPacketThreadsafe;
...
public class TinkerStationTabPacket extends AbstractPacketThreadsafe {
  ...
  public void handleServerSafe(NetHandlerPlayServer netHandler) {
    ...
    if(state.getBlock() instanceof ITinkerStationBlock) {
      ...
      player.openGui(CraftingStation.instance, 0, player.getEntityWorld(), blockX, blockY, blockZ);
    }
