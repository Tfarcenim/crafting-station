 ...
 * Basically it ju
 */
public class SlotFastCrafting extends SlotCrafting {
  ...
  public SlotFastCrafting(ContainerCraftingStation containerCraftingStation, EntityPlayer player, InventoryCraftingPersistent craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
